...
function Lobby(props) {
	const { profile, balance, onClaim, claimed, online, matching, matchCount, rescued, onRescue, onModeChange, onStartLocal, onStartOnline, onCancelMatch, onProfileChange, onClose } = props;
	...
	return (0, react.createElement)("div", { className: "ddz-body ddz-lobby" }, (0, react.createElement)("div", { className: "ddz-lobby-top" }, (0, react.createElement)("div", { className: "ddz-lobby-profile-stack" }, (0, react.createElement)("div", { className: "ddz-profile ddz-row" }, (0, react.createElement)("div", { className: "ddz-avatar-picker-anchor" }, (0, react.createElement)("button", {
		type: "button",
	...
	}, "在线对战"))), (0, react.createElement)("div", { className: "ddz-lobby-intro" }, (0, react.createElement)("div", { className: "ddz-section-title" }, "选择桌别"), (0, react.createElement)("div", { className: "ddz-dim ddz-lobby-subtitle" }, online ? "在线匹配 3 名真人玩家（Cloudflare 云端对局）" : "开局自动匹配 2 个本地机器人（M1 本地演示）")), (0, react.createElement)("div", { className: "ddz-table-grid" }, ...CONFIG.tables.map((t) => (0, react.createElement)("button", {
		key: t.id,
		type: "button",
		...
		className: "ddz-btn ddz-btn-ghost",
		onClick: onClose
	}, "最小化")), balance < (online ? tableById(tableId)?.minBalance ?? 0 : tableById(tableId)?.base ?? 0) && (0, react.createElement)("div", { className: "ddz-dim ddz-helper" }, online ? "余额不足该桌门槛，先签到或领救济金" : "余额不足该桌底注，先签到或换低倍桌"));
}
const HUMAN_SEAT = 0;
...
function OnlineTable(props) {
	...
	const latencyFooter = (0, react.createElement)("div", {
		...
		role: "status",
		"aria-live": "polite"
	}, (0, react.createElement)("span", { className: "ddz-latency-dot" }), latencyMs === null ? (0, react.createElement)("span", null, "网络延迟 —") : (0, react.createElement)("span", null, "网络延迟 ", (0, react.createElement)("b", null, `${latencyMs}ms`)));
...
function DoudizhuApp() {
	...
	const enterOnline = async () => {
		try {
			...
			if (h.protocol !== 1) {
				setNotice(`版本不兼容：客户端协议 v1 ≠ 服务器 v${h.protocol}（服务器 ${h.version}）。请更新插件后重试。`);
				return;
			}
