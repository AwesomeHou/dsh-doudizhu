...
function tableViewFromProtocol(p) {
	...
	return {
		...
		seats: p.seats.map((s) => ({
			...
			hand: s.hand ? s.hand.map(asCard) : void 0
		})),
...
function CardView({ card, selected, onClick, size = "normal" }) {
	...
	if (isJoker) {
		...
		return (0, react.createElement)("div", {
			...
			className: "ddz-card-corner top ddz-joker-corner",
			"aria-hidden": true
		}, ...letters.map((ch, i) => (0, react.createElement)("span", {
			key: i,
			className: "ddz-joker-letter"
		}, ch))), (0, react.createElement)("span", {
	...
	}, (0, react.createElement)("span", { className: "ddz-card-corner top" }, (0, react.createElement)("span", { className: "ddz-card-rank" + rankClass }, rank), (0, react.createElement)("span", { className: "ddz-card-suit" }, suit)), (0, react.createElement)("span", {
...
function GameTableShell(props) {
	...
	return (0, react.createElement)("div", { className: "ddz-body ddz-table-screen" }, (0, react.createElement)("button", {
		...
		className: "ddz-row",
		style: { gap: 10 }
	}, view.landlord === view.mySeat && !view.revealed[view.mySeat] && (0, react.createElement)("button", {
		className: "ddz-btn ddz-btn-red",
		onClick: () => {
			onMing();
			showAction(view.mySeat, "明牌");
