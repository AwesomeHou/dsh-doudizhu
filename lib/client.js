...
function GameTableShell(props) {
	...
	return (0, react.createElement)("div", { className: "ddz-body ddz-table-screen" }, (0, react.createElement)("button", {
	...
	}, (0, react.createElement)("div", { className: "ddz-table-turn-label" }, view.phase === "calling" ? callAnnouncement ?? (isMyTurn ? `轮到你${callLabel}` : "等待叫地主…") : view.phase === "playing" ? callAnnouncement ?? (isMyTurn ? "轮到你出牌" : "对手出牌中…") : "")), (0, react.createElement)("div", { className: "ddz-side-zone right" }, botB && (0, react.createElement)(PlayedArea, {
		seat: botB.seat,
		...
		className: "ddz-btn",
		onClick: () => onCall(true)
	}, callLabel), (0, react.createElement)("button", {
		className: "ddz-btn ddz-btn-ghost",
		onClick: () => onCall(false)
	}, view.hasCalled ? "不抢" : "不叫")) : (0, react.createElement)("span", { className: "ddz-action-status ddz-dim" }, "等待叫地主…") : view.phase === "playing" ? isMyTurn ? (0, react.createElement)("div", {
		className: "ddz-row",
		style: { gap: 10 }
	}, (0, react.createElement)("button", {
		className: "ddz-btn",
...
function Lobby(props) {
	const { profile, balance, onClaim, claimed, online, matching, matchCount, rescued, onRescue, syncing, lobbyLatency, onModeChange, onStartLocal, onStartOnline, onCancelMatch, onProfileChange, onClose } = props;
	...
	return (0, react.createElement)(react.Fragment, null, (0, react.createElement)("div", { className: "ddz-body ddz-lobby" }, (0, react.createElement)("div", { className: "ddz-lobby-top" }, (0, react.createElement)("div", { className: "ddz-lobby-profile-stack" }, (0, react.createElement)("div", { className: "ddz-profile ddz-row" }, (0, react.createElement)("div", { className: "ddz-avatar-picker-anchor" }, (0, react.createElement)("button", {
	...
	}, (0, react.createElement)(EditIcon))), (0, react.createElement)("div", { className: "ddz-dim ddz-profile-uid" }, "UID " + profile.uid.slice(0, 8))), (0, react.createElement)("span", { className: "ddz-rank" }, rank.name)), (0, react.createElement)("div", { className: "ddz-balance ddz-row" }, (0, react.createElement)("div", { className: "ddz-balance-copy" }, (0, react.createElement)("div", { className: "ddz-balance-label" }, "Token 余额" + (online ? "（在线）" : "")), (0, react.createElement)("div", { className: "ddz-balance-value" }, balance.toLocaleString()), online && syncing && (0, react.createElement)("div", {
		className: "ddz-dim",
		style: { fontSize: 12 }
		...
		className: "ddz-btn ddz-btn-ghost",
		onClick: onClose
	}, "最小化")), balance < (online ? tableById(tableId)?.minBalance ?? 0 : tableById(tableId)?.base ?? 0) && (0, react.createElement)("div", { className: "ddz-dim ddz-helper" }, online ? "余额不足该桌门槛，先签到或领救济金" : "余额不足该桌底注，先签到或换低倍桌")), (0, react.createElement)("div", { className: "ddz-lobby-version" }, `斗地主 v${APP_VERSION}`), (0, react.createElement)("div", { className: "ddz-disclaimer" }, "Token 为虚拟货币，仅作娱乐用途，不可兑换任何真实货币或服务（性质类似欢乐豆）"));
}
const HUMAN_SEAT = 0;
const CALL_ACTION_DELAY_MS = 1200;
const CALL_ANNOUNCEMENT_MS = 1650;
...
function LocalTable(props) {
	...
	const [callAnnouncement, setCallAnnouncement] = (0, react.useState)(null);
	...
	const previousTurnRef = (0, react.useRef)(`${state.phase}:${state.current}`);
	(0, react.useEffect)(() => {
	...
	const announceCall = (seat, call, hasCalled) => {
		const message = `${seatMeta[seat]?.nickname ?? `座位${seat}`}${hasCalled ? call ? "抢地主" : "不抢" : call ? "叫地主" : "不叫"}`;
...
function clampPipBounds(bounds) {
