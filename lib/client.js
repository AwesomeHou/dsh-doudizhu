...
function PlayedArea({ seat, humanSeat = 0, cards, countdownSeconds = null, action = null }) {
	...
	const actionClass = action ? action.text === "叫地主" || action.text === "抢地主" ? "" : " is-pass" : "";
	return (0, react.createElement)("div", {
...
function GameTableShell(props) {
	...
	(0, react.useEffect)(() => {
		if (view.phase === "calling" && view.callActor === 0) setActionText({});
	...
	return (0, react.createElement)("div", { className: "ddz-body ddz-table-screen" }, (0, react.createElement)("button", {
		...
		onClick: () => {
			onCall(true);
			showAction(view.mySeat, view.hasCalled ? "抢地主" : "叫地主");
		}
	}, callLabel), (0, react.createElement)("button", {
		className: "ddz-btn ddz-btn-ghost",
		onClick: () => {
			onCall(false);
			showAction(view.mySeat, view.hasCalled ? "不抢" : "不叫");
		}
...
function Lobby(props) {
	...
	return (0, react.createElement)(react.Fragment, null, (0, react.createElement)("div", { className: "ddz-body ddz-lobby" }, (0, react.createElement)("div", { className: "ddz-lobby-top" }, (0, react.createElement)("div", { className: "ddz-lobby-profile-stack" }, (0, react.createElement)("div", { className: "ddz-profile ddz-row" }, (0, react.createElement)("div", { className: "ddz-avatar-picker-anchor" }, (0, react.createElement)("button", {
		...
		className: "ddz-btn ddz-btn-ghost",
		onClick: onClose
	}, "最小化")), balance < (tableById(tableId)?.minBalance ?? 0) && (0, react.createElement)("div", { className: "ddz-dim ddz-helper" }, "余额不足该桌门槛，先签到或领救济金")), (0, react.createElement)("div", { className: "ddz-lobby-version" }, `斗地主 v${APP_VERSION}`), (0, react.createElement)("div", { className: "ddz-disclaimer" }, "Token 为虚拟货币，仅作娱乐用途，不可兑换任何真实货币或服务（性质类似欢乐豆）"), rankInfoOpen && (0, react.createElement)("div", {
